...
#include "esp_log.h"
#include "esp_bt.h" //BT Controller and VHCI configuration from the host side

#include "esp_gap_ble_api.h" //GAP configuration
#include "esp_gatts_api.h"   //GATT configuration, advertising and connection parameters
#include "esp_bt_defs.h"
#include "esp_bt_main.h" //Initialization and enables bluedroid stack
...
#define CHAR_DECLARATION_SIZE (sizeof(uint8_t) * 100)
...
static esp_ble_adv_data_t adv_data = {
    //Parameters to set the advertising
    .set_scan_rsp = false,
    .include_name = true,
...
static esp_ble_adv_params_t adv_params = {
    //Parameters to start advertising
    .adv_int_min = 0x20,
    .adv_int_max = 0x40,
...
static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_SCAN_RSP_DATA_RAW_SET_COMPLETE_EVT:
        ...
        break;
#else
    //Triggered and managed by the GAP event once the advertising data have been set
    ...
    case ESP_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT:
        ...
        break;
#endif
    //Triggered once the advertising has started, and checks if it was a success
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    {
        ESP_LOGI(GATTS_TAG, "GATT_SET_ATTR_VAL_EVT, handle = %d, value = %d", param->set_attr_val.attr_handle, param->set_attr_val.srvc_handle);
        break;
    }
...
void ble_init(void)
{
    ...
    //Initialization of the BT controller
    ...
    //Initializing and Enabling Bluedroid stack
    ...
    //Application Profiles are registered
